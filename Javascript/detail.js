...
fetch(`${BASE_URL}articles/${articleId}`)
  ...
  .then((res) => {
    ...
    contentHTML += `
      ...
      <ol class="breadcrumb hidden-xs-down">
          ...
          <li class="breadcrumb-item active">${article.category.name}</li>
      </ol>

      <span class="color-aqua"><a href="blog-category-01.html" title="">${article.category.name}</a></span>

      <h3>${article.title}</h3>

      <div class="blog-meta big-meta">
          <small><a href="single.html" title="">${pubDate}</a></small>
  ...
  <div class="blog-title-area">
      <div class="tag-cloud-single">
          <span>Tags</span>
          <small><a href="#" title="">${article.category.name}</a></small>
      </div><!-- end meta -->
  ...
  <div class="custombox authorbox clearfix">
      ...
      <div class="row">
          ...
          <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
              ...
              <p>I am a Fashion designer, Makeup artist, and Blog writer.</p>
  ...
  <div class="custombox clearfix">
    ...
    articleDetail.innerHTML = contentHTML;
  })    
  .catch((error) => {
    window.location.href = '404.html';
  });

fetch(`https://apiforlearning.zendvn.com/api/v2/articles/${articleId}/related?limit=3`)
  .then((response) => response.json())
  .then((res) => {
    ...
    document.getElementById("article-sidebar").innerHTML = contentHTML;
  });
