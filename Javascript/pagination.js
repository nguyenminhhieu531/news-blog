...
function renderPagination(page, total) {
  ...
  let content = `<li class="page-item"><a class="page-link page-numbers ${isFirstPage}" href="#" id="btn-prev">Prev</a></li>`;

  for (let i = start; i <= end; i++) {
    if (i === page) {
      content += `<li class="page-item"><a class="page-link page-numbers current">${i}</a></li>`;            
    } else {
      content += `<li class="page-item"><a class="page-link page-numbers" data-page="${i}">${i}</a></li>`;
    }
  }

  content += `<li class="page-item"><a class="page-link page-numbers ${isLastPage}" href="#" id="btn-next">Next</a></li>`;
